...
body, header, section, footer, div, ul, li, p, a, span, input, textarea
	{
...
#nav {
	...
	width: 15%;
	height: 100%;
	box-shadow: 0 0 3px 0.5px rgb(228, 228, 228);
...
#util .util_inner li:last-child {
	margin-right: 0;
}

#util .util_inner li svg {
	position: relative;
	top: 15px;
	left: 15px;
}

#util .util_inner li img {
	width: 100%;
}
...
#common_list_form .big_title {
	padding: 50px 50px;
}

#common_list_form .sub_title {
	padding: 20px 50px;
}

#common_list_form .list_form {
	position: relative;
}

#common_list_form .list_form .list_title ul {
	width: 100%;
	height: 32px;
}

#common_list_form .list_form .list_title ul li {
	float: left;
...
#common_list_form .list_form .list_title ul li:first-child {
	width: 15%;
	padding-left: 50px;
}

#common_list_form .list_form .list_title ul li:nth-child(2) {
	width: 10%;
}

#common_list_form .list_form .list_title ul li:nth-child(3) {
	width: 5%;
}

#common_list_form .list_form .list_title ul li:nth-child(4) {
	width: 50%;
}

#common_list_form .list_form .list_title ul li:nth-child(5) {
	width: 5%;
}

#common_list_form .list_form .list_title ul li:last-child {
	width: 15%;
}

#common_list_form .list_form .list_content ul {
	width: 100%;
	height: 30px;
}

#common_list_form .list_form .list_content ul li {
	float: left;
	padding: 5px 0 5px 10px;
	box-sizing: border-box;
}

#common_list_form .list_form .list_content ul li:first-child {
	width: 15%;
	padding-left: 50px;
}

#common_list_form .list_form .list_content ul li:nth-child(2) {
	width: 10%;
}

#common_list_form .list_form .list_content ul li:nth-child(3) {
	width: 5%;
}

#common_list_form .list_form .list_content ul li:nth-child(4) {
	width: 50%;
}

#common_list_form .list_form .list_content ul li:nth-child(5) {
	width: 5%;
}

#common_list_form .list_form .list_content ul li:last-child {
	width: 15%;
}

#common_list_form .list_form .list_content ul li a:hover {
	text-decoration: underline;
}

#common_list_form .list_form .list_content ul:hover {
	background-color: #eee;
}
...
<body>
	...
	<div id="nav">
		<div class="nav_inner">
			<h1 class="logo">
				<a href="javascript:">Hoony Music</a>
			</h1>
			<ul class="gnb">
				...
				<ul data-index="2">
					...
					<a href="javascript:"><li class="dep2" data-index="3">결재
							보관함
							<div class="arrow">
								<svg width="12" height="12" viewBox="0 0 1024 1024"
									xmlns="http://www.w3.org/2000/svg">
				...
				<ul data-index="4">
					...
					<a href="javascript:"><li class="dep2" data-index="5">부서
							일정
							<div class="arrow">
								<svg width="12" height="12" viewBox="0 0 1024 1024"
									xmlns="http://www.w3.org/2000/svg">
	...
	<div id="util">
		<ul class="util_inner">
			<li class="search"><svg width="24" height="24"
					viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path fill="#eb568e"
						d="M10 18a7.952 7.952 0 0 0 4.897-1.688l4.396 4.396l1.414-1.414l-4.396-4.396A7.952 7.952 0 0 0 18 10c0-4.411-3.589-8-8-8s-8 3.589-8 8s3.589 8 8 8m0-14c3.309 0 6 2.691 6 6s-2.691 6-6 6s-6-2.691-6-6s2.691-6 6-6" />
                </svg></li>
			<li class="Notification"><svg width="24" height="24"
					viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path fill="#eb568e"
	...
	<section id="common_list_form">
		...
		<div class="list_form">
			...
			<form action="copyrightregister" method="POST"
				...
				<table style="margin-left: auto; margin-right: auto;">
					<tr style="border: solid 1px black; border-collapse: collapse;">
						<td style="border: solid 1px black; border-collapse: collapse;">
							저작권 번호 : <input type="text" id="searchbar" placeholder="저작권번호"
							name="no" />
						</td>
						<td style="border: solid 1px black; border-collapse: collapse;">
							음원명 : <input type="text" placeholder="음원명" id="namae"
							name="namae" />
						</td>
					</tr>
					<tr style="border: solid 1px black; border-collapse: collapse;">
						...
						<td style="border: solid 1px black; border-collapse: collapse;">
							계약일 : <input type="date" id="cont" class="datePicker"
							value="2018-07-22" min="2018-01-01" max="2018-12-31" name="cont" />
						</td>
					</tr>
					<tr style="border: solid 1px black; border-collapse: collapse;">
						<td style="border: solid 1px black; border-collapse: collapse;">
						...
						<td style="border: solid 1px black; border-collapse: collapse;">
							아티스트 명 : <input type="text" placeholder="아티스트명" id="name"
							name="name" />
						</td>
					</tr>
					<tr style="border: solid 1px black; border-collapse: collapse;">
						<td style="border: solid 1px black; border-collapse: collapse;">
							담당자 : <input type="text" placeholder="담당자" id="member"
							name="member" />
						</td>
						<td style="border: solid 1px black; border-collapse: collapse;">
		...
		dep1Items.forEach(function(item) {
			item.addEventListener('click',
					function() {
						...
						var targetUl = document
								.querySelector('.gnb ul[data-index="'
										+ dataIndex + '"]');
						...
						if (!isActive) {
							...
							$(targetUl).siblings('ul').removeClass('active')
									.slideUp(300);
							$(this).addClass('active');
							$(this).find('.arrow>svg').css('transform',
									'rotate(90deg)');
							if ($(this).parents('a').siblings().find(
									'li .arrow svg').css('transform',
									'rotate(90deg)')) {
								$(this).parents('a').siblings().find(
										'li .arrow svg').css('transform',
										'rotate(0deg)');
								$(this).parents('a').siblings().find(
		...
		dep2Items.forEach(function(item) {
			item.addEventListener('click',
					function(e) {
						var dataIndex = item.getAttribute('data-index');
						var targetUl = document
								.querySelector('.gnb ul ul[data-index="'
										+ dataIndex + '"]');
						var isActive = targetUl.classList.contains('active');
		...
		$.ajax({
			...
			success : function(data) {
				...
				data.data.forEach(function(item) {
					...
					content += '<div class="CONT_TITLE">' + "<h3 "
							+ 'onClick = "copyrightsearchdetail(' + "'"
							+ item.REG_ID + "','" + page + "','" + perPage
							+ "'" + ')">' + item.CONT_TITLE + "</h3>"
							+ '</div>';
					content += '<div class="REG_DATE">' + item.REG_DATE
							+ '</div>';
					//content += '</a>';
					content += '</li>';
				});
